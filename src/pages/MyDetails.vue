    ...
    <v-layout justify-center>
      <v-flex elevation-6 xs9>
        <v-toolbar flat tabs>
            ...
            >
              <v-tab ripple>
                <v-icon color="red" class="validationIcon" v-if="userData.checkData.basicDetails==false">highlight_off</v-icon>
                <v-icon color="green" class="validationIcon" v-else>check_circle</v-icon>
                General
              </v-tab>
              <v-tab ripple>
                <v-icon color="red" class="validationIcon" v-if="userData.checkData.residentialDetails==false">highlight_off</v-icon>
                <v-icon color="green" class="validationIcon" v-else>check_circle</v-icon>
                Residential
              </v-tab>
              <v-tab ripple>
                <v-icon color="red" class="validationIcon" v-if="userData.checkData.employmentDetails==false">highlight_off</v-icon>
                <v-icon color="green" class="validationIcon" v-else>check_circle</v-icon>
                Employment
              </v-tab>
              <v-tab ripple>
                <v-icon color="red" class="validationIcon" v-if="userData.checkData.incomeDetails==false">highlight_off</v-icon>
                <v-icon color="green" class="validationIcon" v-else>check_circle</v-icon>
                Income
              </v-tab>
              <v-tab ripple>
                <v-icon color="red" class="validationIcon" v-if="userData.checkData.assetDetails==false">highlight_off</v-icon>
                <v-icon color="green" class="validationIcon" v-else>check_circle</v-icon>
                Assets
              </v-tab>
              <v-tab ripple>
                <v-icon color="red" class="validationIcon" v-if="userData.checkData.liabilitiesDetails==false">highlight_off</v-icon>
                <v-icon color="green" class="validationIcon" v-else>check_circle</v-icon>
                Liabilities
              </v-tab>
            <v-tab-item>
